...
public class String2 {
    public static void main(String[] args) throws Exception {
        ...
        String s3 = new String(s2.getBytes(StandardCharsets.UTF_8), "utf-8");
        ...
        System.out.println("b.equals(\"aaabbb\") = " + b.equals("aaabbb"));
        System.out.println("a.equals(b) = " + a.equals(b));
        System.out.println("a.equalsIgnoreCase(\"AAA\") = " + a.equalsIgnoreCase("AAA"));
        System.out.println("b.equalsIgnoreCase(\"BBB\") = " + b.equalsIgnoreCase("BBB"));
        ...
        System.out.println("aaabbbb".contains("aaa"));
        System.out.println(b.contains(a));

        System.out.println("호길동".compareTo("김길동"));
        System.out.println("호길동".compareTo("박길동"));
        System.out.println("호길동".compareTo("호길동"));
        ...
        System.out.println(str5.indexOf("abc", 1));
